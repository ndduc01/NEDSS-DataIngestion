...
//    }
    ...
    void hl7Validation_FHSMessage() throws DiHL7Exception {
        String message =
                "FHS|^~\\&|ELR|NIST|NIST|NIST|20150708||FHSeg|Generated by ELR Route|FHSAppGen20150708|Application Generate\n" +
                "BHS|^~\\&|NIST|NIST|NIST|NIST|20150708||BHSeg|Application Generated|BHSAppGen20150708|P\n" +
                "MSH|^~\\&|NIST^TBD^ISO|NIST^TBD^ISO|NIST^TBD^ISO|NIST^TBD^ISO|20120821140551-0500000||ORU^R01|NIST-ELR-001.03|T|2.3.1|||NE|NE\n" +
                "PID|1||18789547^^^NIST MPI&TBD&ISO^MR^Shady Tree&TBD&ISO~131131313^^^SSN&TBD&ISO^SS^SSA&TBD&ISO||Sanchez^Abel^G.^Jr^^^L~DUC^Luis^Munoz^Jr^^^B|Sanchez^Rose^G.^Sr^Dr^^M|19800320|M||W|6 Maple Drive^Apt 1^Philadelphia^PA^19136^USA^H^^42101~131 Broad Street^Apt 31^Philadelphia^PA^19136^USA^C^^42101||^PRN^CP^^1^215^5551214^4^call before 8PM~^NET^Internet^sangel@yahoo.com^^^^^home|^WPN^PH^^1^215^5551214^4^call before 8PM||||||||H||||||||N\n" +
                "ORC|RE|3456723^NIST_Placer _App^TBD^ISO|system generated|system generated^NIST_Sending_App^TBD^ISO||||||||131131131^Remala^Swathi^T^JR^DR^^^NPI&TBD&ISO^L^^^NPI^NPI_Facility&TBD&ISO||^WPN^PH^^1^215^5556600^13^Hospital Line~^BPN^BP^^1^215^5553531^131^Beeper number|||||||Shady Tree Free Clinic^L^^^^NIST sending app&TBD&ISO^XX|900 Emerson Road^Building 1^Philadelphia^PA^19137^USA^L^^42101|^WPN^PH^^1^215^5556600^13^Call  9AM  to 5PM|1200 Professional Way^Suite 114^Philadelphia^PA^19131^USA^B^^42101\n" +
                "OBR|1|3456723^NIST_Placer _App^TBD^ISO|system generated|24467-3^CD3+CD4+ (T4 helper) cells [#/volume] in Blood^LN^2153^ABSOLUTE CD4+ CELLS^L|||20120801|20120801|5^mL||||Confirmed HIV infection|20120802080000500|258580003&Whole blood sample (specimen)&SNM&BLD&Whole Blood EDTA&L^Potassium/K EDTA^^244001006&Antecubital fossa&SNM&ELBL&Elbow, Left&L^263925004&Venous (qualifier value)&SNM&Ven&Venous&L^82078001&Collection of blood specimen for laboratory (procedure)&SNM&VBD&Venous Blood Draw&L|131131131^Remala^Swathi^T^JR^DR^^^NPI&TBD&ISO^L^^^NPI^NPI_Facility&TBD&ISO|^WPN^PH^^1^215^5556600^13^Hospital Line~^BPN^BP^^1^215^5553531^131^Beeper number|||||20120802160000500|||F||||||042^Human immunodeficiency virus [HIV] disease [42]^TBD^HIV^HIV/Aids^L|131&Varma&Raja&Rami&JR&DR&PHD&&NIST_Sending_App2.16.840.1.113883.3.72.5.21ISO\n" +
                "OBX|1|SN|24467-3^CD3+CD4+ (T4 helper) cells [#/volume] in Blood^LN^2153^ABSOLUTE CD4+ CELLS^L||=^440|{Cells}/uL^cells per microliter^UCUM^cells/mcL^cells per microliter^L|649-1346 cells/mcL|L|||F|||20120801|01D7654321^Philadelphia City Public Health Lab^CLIA||0251^Flow Cytometry (FC)^TBD^FC^Flow Cytometry^L\n" +
                "NTE|1||Performing Lab Address: 7901 State Road, Philadelphia, PA  19137\n" +
                "NTE|2||Age at Specimen Collection(35659-2[LN]): =\\S\\32 Year\n" +
